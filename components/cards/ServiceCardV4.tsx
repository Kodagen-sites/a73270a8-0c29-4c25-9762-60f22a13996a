    ...
    >
      ...
      <div
        ...
        style={{
          padding: 1,
          background:
            "conic-gradient(from 180deg at 50% 50%, rgba(217,70,239,0.6), rgba(240,171,252,0.6), rgba(217,70,239,0.6))",
          WebkitMask:
      ...
      <GlassCursorHighlight accent="var(--primary-color, #D946EF)" opacity={0.28} radius={320}>
        {imageSrc && (

  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-3xl px-5 pb-24 pt-32 text-white md:px-8 md:pt-40">
        ...
        <p className="mt-3 text-sm text-white/55">Effective {effectiveDate}</p>

        <div className="mt-12 space-y-8 leading-relaxed [&_h2]:mt-10 [&_h2]:mb-3 [&_h2]:font-display [&_h2]:text-xl [&_h2]:font-medium [&_li]:text-white/75 [&_p]:text-white/75 [&_ul]:list-disc [&_ul]:space-y-1 [&_ul]:pl-6">
          <p>
          ...
          <div>
            ...
            <ul>
              <li><strong>Information you provide</strong> — name, email, and any message you send through our contact or enquiry forms.</li>

  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-3xl px-5 pb-24 pt-32 text-white md:px-8 md:pt-40">
        ...
        <div className="mt-12 space-y-8 leading-relaxed [&_h2]:mt-10 [&_h2]:mb-3 [&_h2]:font-display [&_h2]:text-xl [&_h2]:font-medium [&_p]:text-white/75">
          <p>
          ...
          <div>
            ...
            <p>
              ...
              {company} or its licensors and is protected by copyright and other laws. You may not
